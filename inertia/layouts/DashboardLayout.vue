...
import { BarChartIcon, BoxIcon, MenuIcon, XIcon } from "lucide-vue-next";
import { usePage } from "@inertiajs/vue3";
import { Link } from "@inertiajs/vue3";

const navigation = [
  { name: "Dashboard", href: "/dashboard", icon: BarChartIcon, current: true },
  { name: "Projects", href: "/dashboard/projects", icon: BoxIcon, current: false }
];
const page = usePage();
